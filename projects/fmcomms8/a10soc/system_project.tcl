...
set_location_assignment PIN_N29   -to ref_clk_c                ; ## D04 FMC_HPC_GBTCLK0_M2C_P (NC)
set_location_assignment PIN_N28   -to "ref_clk_c(n)"           ; ## D05  FMC_HPC_GBTCLK0_M2C_N (NC)
...
set_location_assignment PIN_L37   -to tx_serial_data_c[2]      ; ## A26  FMC_HPC_DP2_C2M_P (tx_serial_data_p[2])
set_location_assignment PIN_L36   -to "tx_serial_data_c[2](n)" ; ## A27  FMC_HPC_DP2_C2M_N (tx_serial_data_n[2])
set_location_assignment PIN_K39   -to tx_serial_data_c[3]      ; ## A30  FMC_HPC_DP3_C2M_P (tx_serial_data_p[3])
set_location_assignment PIN_K38   -to "tx_serial_data_c[3](n)" ; ## A31  FMC_HPC_DP3_C2M_N (tx_serial_data_n[3])
